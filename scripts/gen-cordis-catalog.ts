...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  LibraryConverter: 'conversion seam contract is owned by packages/library/library/src/convert/types.ts',
  Notebook: 'library entity snapshot is owned by packages/library/library/src/types.ts',
  NotebookId: 'library branded id is owned by packages/library/library/src/types.ts',
  Resource: 'library entity snapshot is owned by packages/library/library/src/types.ts',
  ResourceId: 'library branded id is owned by packages/library/library/src/types.ts',
  IngestRequest: 'library ingest request is owned by packages/library/library/src/types.ts',
  NotebookStructure: 'library structure listing is owned by packages/library/library/src/types.ts',
  ScoredChunk: 'library retrieval unit is owned by packages/library/library/src/chunk.ts',
  AskResult: 'library grounded answer is owned by packages/library/library/src/types.ts',
  AskOrigin: 'library ask-log origin is owned by packages/library/library/src/types.ts',
  AskLogEntry: 'library ask-log entry is owned by packages/library/library/src/types.ts',
  AskRequest: 'library wire request is owned by packages/library/library-api/src/types.ts',
  AskView: 'library wire view is owned by packages/library/library-api/src/types.ts',
  AskLogEntryView: 'library wire view is owned by packages/library/library-api/src/types.ts',
  CreateNotebookRequest: 'library wire request is owned by packages/library/library-api/src/types.ts',
  RenameNotebookRequest: 'library wire request is owned by packages/library/library-api/src/types.ts',
  NotebookRequest: 'library wire request is owned by packages/library/library-api/src/types.ts',
  ResourceRequest: 'library wire request is owned by packages/library/library-api/src/types.ts',
  IngestTextRequest: 'library wire request is owned by packages/library/library-api/src/types.ts',
  MarkdownView: 'library wire view is owned by packages/library/library-api/src/types.ts',
  NotebookView: 'library wire view is owned by packages/library/library-api/src/types.ts',
  ResourceView: 'library wire view is owned by packages/library/library-api/src/types.ts',
